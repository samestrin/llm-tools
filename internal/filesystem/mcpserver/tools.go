		...
		// Core File Operations
		{
			...
			InputSchema: json.RawMessage(`{
				...
				"properties": {
					...
					"max_size": {"type": "integer", "description": "Maximum JSON output size in characters (default: 70000, -1 = no limit). Uses smart estimation to account for JSON encoding overhead.", "default": 70000},
